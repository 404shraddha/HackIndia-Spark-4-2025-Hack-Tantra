    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black/30 backdrop-blur-lg border-b border-white/10">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
            ...
            <Link to="/debates" className="nav-link group">
              ...
              <div
                className={`nav-link-underline ${
                  location.pathname === "/debates" ? "w-full opacity-100" : ""
                }`}
              />
            </Link>
          ...
          <div className="hidden md:flex items-center">
            <Link to="/signup" className="arcade-button-sm">
              {" "}
      ...
      <div className={`md:hidden ${isMenuOpen ? "block" : "hidden"}`}>
        <div className="px-4 pt-2 pb-4 space-y-2 bg-black/50 backdrop-blur-lg">
          <Link
            to="/debates"
            className="block px-4 py-2 text-gray-100 hover:bg-gray-700 rounded-md"
          >
          ...
          <Link
            to="/signup"
            className="block w-full px-4 py-3 mt-4 text-center bg-emerald-500 text-white rounded-md hover:bg-emerald-600"
          >
